...
pug_html = pug_html + "\u003C\u002Fspan\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Cb class=\"term\"\u003EPR: \u003C\u002Fb\u003E\u003Cspan class=\"text\"\u003E" + (pug_escape(null == (pug_interp = cve.source.defect) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Cb class=\"term\"\u003EAffects: \u003C\u002Fb\u003E\u003Cspan class=\"text\"\u003E" + (pug_escape(null == (pug_interp = textUtil.getProductAffected(cve)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan class=\"text\"\u003E" + (pug_escape(null == (pug_interp = textUtil.getProductAffected(cve)) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Cb class=\"term\"\u003EProblem: \u003C\u002Fb\u003E\u003Cspan class=\"text\"\u003E";
...
if (cmap[id] && cmap[id].impact && cmap[id] && cmap[id].impact.cvss && cmap[id] && cmap[id].impact.cvss[0] && cmap[id] && cmap[id] && cmap[id].impact.cvss[0].version in ["3.0", "3.1"]) {
pug_mixins["CVSS"](cmap[id].impact.cvss[0]);
}
...
if (cve.impact && cve.impact.cvss && cve.impact.cvss[0] && cve.impact.cvss[0].version >= "3") {
pug_html = pug_html + "\u003Cp\u003E";
pug_mixins["CVSS"](cve.impact.cvss[0]);
pug_html = pug_html + "\u003C\u002Fp\u003E";
if (cve.impact.cvss[0].baseSeverity) {
pug_html = pug_html + "\u003Ch4\u003ERISK LEVEL:\u003C\u002Fh4\u003E\u003Cp\u003E" + (pug_escape(null == (pug_interp = cve.impact.cvss[0].baseSeverity) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
}
}
